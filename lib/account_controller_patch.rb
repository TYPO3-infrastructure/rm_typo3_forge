...
#      flash.now[:error] = l(:notice_account_invalid_credentials)
      flash.now[:error] << "<br /><br />NOTE: As of April 10th, 2017 TYPO3 Forge uses LDAP authentication. Therefore you need a TYPO3.org LDAP account to log in. An LDAP account is automatically created if you log in at <a href=\"https://typo3.org\" target=\"_blank\">https://typo3.org/</a>.<br />To proceed, please log in once at <a href=\"https://typo3.org\" target=\"_blank\">https://typo3.org/</a> and return to this page afterwards."
#
